...
const showEmployeeSummary = async () => {
    console.log(' ');
...
// Displays employees and their roles
...
const confirmStringInput = async input  => {
...
const editEmployeeOptions = async () => {
    inquirer.prompt({
        name: "editChoice",
        type: "list",
...
const editDepartmentOptions = async () => {
    inquirer.prompt({
        name: "editDeps",
        type: "list",
        message: "What would you like to update?",
